...
int irq_for_io_discontig(int file_desc, int cq_id, int irq_no, int cq_flags, uint16_t elem, void *addr);
int irq_for_io_contig(int file_desc, int cq_id, int irq_no, int cq_flags, uint16_t elems);
